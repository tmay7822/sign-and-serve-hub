...
const RealEstateNotary = () => {
  const serviceName = "Real Estate Notarizations";
      ...
      <main>
        ...
        <section className="py-16">
          <div className="container mx-auto px-4 max-w-4xl">
            <h2 className="text-3xl font-bold mb-6">Residential, Investor & Commercial—We've Got You</h2>
            
            <div className="mb-8">
              <ul className="grid md:grid-cols-2 gap-4">
                <li className="flex items-start">
                  <span className="w-2 h-2 bg-brand-gold rounded-full mt-2 mr-3 flex-shrink-0"></span>
                  Full Loan Packages (Buyer, Seller, Refi, HELOC)
                </li>
                <li className="flex items-start">
                  <span className="w-2 h-2 bg-brand-gold rounded-full mt-2 mr-3 flex-shrink-0"></span>
                  Deeds (Warranty, Quitclaim, TOD), Affidavits
                </li>
                <li className="flex items-start">
                  <span className="w-2 h-2 bg-brand-gold rounded-full mt-2 mr-3 flex-shrink-0"></span>
                  Closings, Assignments, Subordinations
                </li>
                <li className="flex items-start">
                  <span className="w-2 h-2 bg-brand-gold rounded-full mt-2 mr-3 flex-shrink-0"></span>
                  Easements & Land Contracts
                </li>
                <li className="flex items-start">
                  <span className="w-2 h-2 bg-brand-gold rounded-full mt-2 mr-3 flex-shrink-0"></span>
                  Private Lender Docs
            ...
            <div className="mb-8 p-6 bg-muted rounded-lg">
              <h3 className="text-2xl font-semibold mb-4">Closing Smoothly</h3>
              <p className="text-muted-foreground">
                We coordinate with title, lenders, and agents. Expect ID checks, signature guidance (no legal advice), and document QC.
              </p>
            </div>
            ...
            <div className="mb-12">
              ...
              <div className="space-y-4">
                <details className="border border-border rounded-lg p-4">
                  <summary className="font-medium cursor-pointer">Evening/weekend closings?</summary>
                  <p className="mt-2 text-muted-foreground">Yes—after-hours across Hamilton, Montgomery, Warren, and Butler Counties.</p>
                </details>
                <details className="border border-border rounded-lg p-4">
                  <summary className="font-medium cursor-pointer">Do you scanback same-day?</summary>
                  <p className="mt-2 text-muted-foreground">Available on request; courier options available.</p>
                </details>
              </div>
            </div>
          </div>
...
export default RealEstateNotary;