...
const HealthcareNotary = () => {
  const serviceName = "Healthcare & Medical Notarizations";
      ...
      <main>
        ...
        <section className="py-16">
          <div className="container mx-auto px-4 max-w-4xl">
            <h2 className="text-3xl font-bold mb-6">Healthcare Directives—Signed Correctly, On Time</h2>
            ...
            <div className="mb-8 p-6 bg-muted rounded-lg">
              <h3 className="text-2xl font-semibold mb-4">What to Know</h3>
              <p className="text-muted-foreground">
                Some healthcare forms require witnesses who are not related or involved in care. Tell us your form requirements and we'll guide you.
              </p>
            </div>
            ...
            <div className="mb-12">
              ...
              <div className="space-y-4">
                <details className="border border-border rounded-lg p-4">
                  <summary className="font-medium cursor-pointer">Can a patient sign if hospitalized?</summary>
                  <p className="mt-2 text-muted-foreground">Yes, if they are alert, aware, and willing. We must confirm capacity.</p>
                </details>
                <details className="border border-border rounded-lg p-4">
                  <summary className="font-medium cursor-pointer">Do you provide witnesses?</summary>
                  <p className="mt-2 text-muted-foreground">Often yes—please request in advance so we can confirm availability.</p>
                </details>
              </div>
            </div>
          </div>
