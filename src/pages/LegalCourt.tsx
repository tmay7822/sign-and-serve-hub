...
const LegalCourt = () => {
  const serviceName = "Legal & Court Notarizations";
      ...
      <main>
        ...
        <section className="py-16">
          <div className="container mx-auto px-4 max-w-4xl">
            <h2 className="text-3xl font-bold mb-6">Sworn & Time-Sensitive Documents—Done Right</h2>
            
            <div className="mb-8">
              <ul className="grid md:grid-cols-2 gap-4">
                <li className="flex items-start">
                  <span className="w-2 h-2 bg-brand-gold rounded-full mt-2 mr-3 flex-shrink-0"></span>
                  Powers of Attorney (General, Durable, Limited, Springing)
                </li>
                <li className="flex items-start">
                  <span className="w-2 h-2 bg-brand-gold rounded-full mt-2 mr-3 flex-shrink-0"></span>
                  Affidavits, Depositions, Sworn Statements
                </li>
                <li className="flex items-start">
                  <span className="w-2 h-2 bg-brand-gold rounded-full mt-2 mr-3 flex-shrink-0"></span>
                ...
                <li className="flex items-start">
                  <span className="w-2 h-2 bg-brand-gold rounded-full mt-2 mr-3 flex-shrink-0"></span>
                  Court Petitions & Motions
                </li>
              </ul>
            </div>

            <div className="mb-8 p-6 bg-muted rounded-lg">
              <h3 className="text-2xl font-semibold mb-4">Neutral, Professional, Precise</h3>
              <p className="text-muted-foreground">
                We verify identity, willingness, and awareness—without giving legal advice. Ask your attorney to pre-review content.
              </p>
            </div>
            ...
            <div className="mb-12">
              ...
              <div className="space-y-4">
                <details className="border border-border rounded-lg p-4">
                  <summary className="font-medium cursor-pointer">Do you notarize at jails/courts?</summary>
                  <p className="mt-2 text-muted-foreground">Yes—by appointment and per facility rules.</p>
                </details>
                <details className="border border-border rounded-lg p-4">
                  <summary className="font-medium cursor-pointer">Do you draft legal documents?</summary>
                  <p className="mt-2 text-muted-foreground">No. We only notarize signatures on documents you provide.</p>
                </details>
              </div>
            </div>
          </div>
