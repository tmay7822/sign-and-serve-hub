  ...
  return (
    ...
    >
      <article className="prose prose-lg max-w-none">
        ...
        <h2>Our process</h2>
        <p>We verify names/IDs first, mark your initial pages, pace the signing so you never feel rushed, and do a final flip-through. That's how packages fund on time.</p>
