...
const WillsTrustsEstates = () => {
  const serviceName = "Wills, Trusts & Estate Notarizations";
      ...
      <main>
        ...
        <section className="py-16">
          <div className="container mx-auto px-4 max-w-4xl">
            <h2 className="text-3xl font-bold mb-6">Plan & Protect With Confidence</h2>
            ...
            <div className="mb-8">
              <ul className="grid md:grid-cols-2 gap-4">
                ...
                <li className="flex items-start">
                  <span className="w-2 h-2 bg-brand-gold rounded-full mt-2 mr-3 flex-shrink-0"></span>
                  Revocable/Irrevocable Trusts & Certifications
                </li>
                <li className="flex items-start">
                  <span className="w-2 h-2 bg-brand-gold rounded-full mt-2 mr-3 flex-shrink-0"></span>
                ...
                <li className="flex items-start">
                  <span className="w-2 h-2 bg-brand-gold rounded-full mt-2 mr-3 flex-shrink-0"></span>
                  Small Estate Affidavits & Executor Oaths
                </li>
                <li className="flex items-start">
                  <span className="w-2 h-2 bg-brand-gold rounded-full mt-2 mr-3 flex-shrink-0"></span>
            ...
            <div className="mb-8 p-6 bg-muted rounded-lg">
              <h3 className="text-2xl font-semibold mb-4">Witness & Capacity</h3>
              <p className="text-muted-foreground">
                Some estate documents need witnesses and clear capacity. We'll help coordinate witnesses and confirm readiness before notarizing.
              </p>
            </div>
            ...
            <div className="mb-12">
              ...
              <div className="space-y-4">
                <details className="border border-border rounded-lg p-4">
                  <summary className="font-medium cursor-pointer">Can you advise on estate strategy?</summary>
                  <p className="mt-2 text-muted-foreground">No legal advice—please consult an attorney. We handle the notarization accurately and promptly.</p>
                </details>
                <details className="border border-border rounded-lg p-4">
                  <summary className="font-medium cursor-pointer">Do you bring witnesses?</summary>
                  <p className="mt-2 text-muted-foreground">Available by request; schedule ahead for availability.</p>
                </details>
              </div>
            </div>
          </div>
...
export default WillsTrustsEstates;