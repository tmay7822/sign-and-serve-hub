          ...
          <Card key={review.id} className="border-accent/20">
            <CardContent className="p-6">
              <div className="flex items-center gap-2 mb-3">
                <div className={`${avatarColors[index % avatarColors.length]} h-8 w-8 rounded-full flex items-center justify-center text-white font-semibold text-sm flex-shrink-0`}>
              ...
              <blockquote className="text-sm text-foreground mb-3 leading-relaxed line-clamp-3">
                "{review.text}"
              </blockquote>
